...
- **Match strength of language to strength of evidence.** Use the appraiser's per-claim labels. High-certainty GRADE → confident wording; Low/Very-Low → hedged ("preliminary evidence suggests," "a single small trial reported"). Never state a Low-certainty finding as established fact.
